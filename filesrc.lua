...
CamShake:Stop()
    ...
    local i = "Menu Break Blox Fruits 🐻"
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Menu Break Blox Fruits 🐻 chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Menu Break Blox Fruits 🐻", HidePremium = false, IntroText = "Menu Break Blox Fruits 🐻⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Menu Break Blox Fruits 🐻",
...
W:AddLabel("Menu Break Blox Fruits 🐻")
...
W:AddLabel("Menu Break Blox Fruits 🐻 SCRIPT")
W:AddLabel("DiscordMenu Break Blox Fruits 🐻")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Menu Break Blox Fruits 🐻(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "Menu Break Blox Fruits 🐻 BOT",
